...
import { CUSTOM_ASSISTANT_DELETE_DIALOG_EVENTS } from "./custom-assistants/dialog-events";
...
function CustomAssistantDeleteDialog() {
  ...
  useEffect(() => {
    ...
    window.Asc.plugin.sendToPlugin(
      CUSTOM_ASSISTANT_DELETE_DIALOG_EVENTS.windowReady,
      {}
    );
  ...
  return (
    <div className="ai_assistant_delete_window noselect">
...
window.Asc.plugin.init = () => {
  const container = document.getElementById("ai_assistant_delete_root");
  if (container) {
