...
const INSTRUCTIONS = `# Instructions for Generating Markdown Documents with Interactive Fields
...
export const generateForm = defineTool({
  name: "generateForm",
  description:
    "Use this function if you are asked to generate a form or document template (contract, any document for filling) based on a description. Input: a detailed description of the desired form or template.",
  inputSchema: {
    type: "object",
    properties: {
      description: {
        type: "string",
        description:
          "Detailed description of the form or template to generate, including purpose, structure.",
      },
    },
