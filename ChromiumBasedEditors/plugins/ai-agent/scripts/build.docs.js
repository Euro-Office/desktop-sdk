...
function cleanTargetDir(dirPath) {
  const preserveFiles = ["index.html", "chat.html", "settings.html", "translation.html", "summarization.html", "annotation-popup.html", "customAction.html", "customActionDelete.html", "config.json"];
