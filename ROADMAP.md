...
This repo provides the **desktop CEF (Chromium Embedded Framework) integration layer** — it embeds the document editor into desktop applications using the Docs API.

## Roadmap Items

### Phase 1 — Foundation

- [ ] Verify Docs API embedding works correctly in CEF-based desktop applications
- [ ] Test editor initialization and event handling in desktop context
- [ ] Validate co-editing works from desktop clients connecting to DocumentServer
